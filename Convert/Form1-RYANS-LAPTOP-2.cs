...
namespace Convert
{
    public partial class Form1 : Form
    {
        ...
        Color front = Color.WhiteSmoke;
        Color front2 = Color.LightGray;
        ...
        beach
        Color[] chartcolors = new Color[] { ColorTranslator.FromHtml("#E8D0A9"), ColorTranslator.FromHtml("#B7AFA3"), ColorTranslator.FromHtml("#C1DAD6"),
                                            ColorTranslator.FromHtml("#F5FAFA"), ColorTranslator.FromHtml("#ACD1E9"), ColorTranslator.FromHtml("#6D929B")};
        */
        Color[] chartcolors = new Color[] { ColorTranslator.FromHtml("#e17a57"), ColorTranslator.FromHtml("#c74b4b"), ColorTranslator.FromHtml("#a13b3b"),
                                            ColorTranslator.FromHtml("#852b2b"), ColorTranslator.FromHtml("#6b0808")};
        ...
        public Form1()
        {
            ...
            //context menu strip
            {
                ...
                ToolStripDropDownButton fruitToolStripDropDownButton = new ToolStripDropDownButton();
        ...
        void menu_Click(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            else if (e.ClickedItem.Text == "Grey")
            {
            ...
            else if (e.ClickedItem.Text == "Red")
            {
                back = Color.Red;
                front = Color.Red;
                front2 = Color.Red;
        ...
        private void CategoryRefreshTrue(int ar, Boolean first)
        {
                ...
                else
                {
                    if (first == false && categoryload == true)
                    {
                        for (int d = 0; d < cats1.Count; d++)
                        {
                            ...
                            if (cat[0] == Purchases.Rows[ar][0].ToString())
                            {
            ...
            if (!categories.Contains(Purchases.Rows[ar][0].ToString()) && Purchases.Rows[ar][0].ToString() != "")
            {
                ...
                if (first == false && categoryload == true)
                {
                    cats.Add(Purchases.Rows[ar][0].ToString() + "~" + Purchases.Rows[ar][2].ToString());
